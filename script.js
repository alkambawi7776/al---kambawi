// Load category files into homepage
...
document.addEventListener("DOMContentLoaded", () => {
  loadSection("breaking-news.html", "breaking-news-container");
  loadSection("nigeria.html", "nigeria-container");
  loadSection("education.html", "education-container");
  loadSection("business-economy.html", "business-economy-container");
  loadSection("sports.html", "sports-container");
  loadSection("weather.html", "weather-container");
  loadSection("entertainment.html", "entertainment-container");
  loadSection("travel.html", "travel-container");
  loadSection("world-news.html", "world-news-container");
  loadSection("short-news.html", "short-news-container");
});
